...
const App = () => {
  const [posts, setPosts] = useState([
    { id: 1, title: 'Post 1', description: 'Description 1', content: 'Content 1', likes: 0, dislikes: 0 },
    { id: 2, title: 'Post 2', description: 'Description 2', content: 'Content 2', likes: 0, dislikes: 0 },
  ]);
